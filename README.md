...
```toml
[dependencies]
robin-sparkless = "0.11.2"
```

Optional features:

```toml
robin-sparkless = { version = "0.11.2", features = ["sql"] }   # spark.sql(), temp views
robin-sparkless = { version = "0.11.2", features = ["delta"] }  # Delta Lake read/write
```
