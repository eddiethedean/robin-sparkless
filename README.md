...
```toml
[dependencies]
robin-sparkless = "0.11.7"
```

Optional features:

```toml
robin-sparkless = { version = "0.11.7", features = ["sql"] }   # spark.sql(), temp views
robin-sparkless = { version = "0.11.7", features = ["delta"] }  # Delta Lake read/write
```
