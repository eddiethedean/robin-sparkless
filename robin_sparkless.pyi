...
class SparkSession:
    ...
    def stop(self) -> None: ...
    def range(
        self, start: int, end: int | None = None, step: int = 1
    ) -> DataFrame: ...
...
class Catalog:
    ...
    def createExternalTable(self, table_name: str) -> None: ...  # raises NotImplementedError
    ...
    def listColumns(
        self, table_name: str, db_name: str | None = None
    ) -> list[str]: ...
    def listFunctions(
