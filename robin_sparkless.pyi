...
class SparkSession:
    ...
    def read_delta_version(self, path: str, version: int | None = None) -> DataFrame: ...
...
class DataFrame:
    ...
    def with_columns(self, mapping: dict[str, Column] | list[tuple[str, Column]]) -> DataFrame: ...
...
def array_join(column: Column, delimiter: str, null_replacement: str | None = None) -> Column: ...
