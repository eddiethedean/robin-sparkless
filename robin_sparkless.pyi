...
class SparkSession:
    ...
    def udf(self) -> None: ...  # raises NotImplementedError
    @classmethod
...
class Catalog:
    ...
    def dropGlobalTempView(self, view_name: str) -> None: ...
...
class Column:
    ...
    def split(self, delimiter: str) -> Column: ...
    ...
    def percent_rank(self, partition_by: list[str], descending: bool = False) -> Column: ...
    def cume_dist(self, partition_by: list[str], descending: bool = False) -> Column: ...
    def ntile(self, n: int, partition_by: list[str], descending: bool = False) -> Column: ...
    def nth_value(self, n: int, partition_by: list[str], descending: bool = False) -> Column: ...
