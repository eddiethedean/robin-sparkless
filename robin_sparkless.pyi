...
class Catalog:
    ...
    def createDatabase(self, name: str, if_not_exists: bool = False) -> None: ...
...
class SparkSessionBuilder:
    ...
    def option(self, key: str, value: str) -> SparkSessionBuilder: ...
...
class DataFrame:
    ...
    def filter(self, condition: Column | bool | str) -> DataFrame: ...
    def where(self, condition: Column | bool | str) -> DataFrame: ...
    def flat_map(
        self, func: Any
    ...
    def cube(self, *cols: str | list[str]) -> CubeRollupData: ...
    def rollup(self, *cols: str | list[str]) -> CubeRollupData: ...
    def agg(
        self, *exprs: Column | list[Column] | tuple[Column, ...]
    ) -> DataFrame: ...  # global aggregation; e.g. df.agg(sum(col("a")), avg(col("b")))
    def limit(self, n: int) -> DataFrame: ...
    def head(self, n: int = 1) -> DataFrame: ...
    ...
    def union(
        self, other: DataFrame | Any
    ) -> DataFrame: ...  # other may be DataFrame-like (.inner or ._df)
    def unionAll(self, other: DataFrame | Any) -> DataFrame: ...
    def union_by_name(
        self, other: DataFrame | Any, allow_missing_columns: bool = True
    ) -> DataFrame: ...
    def intersect(self, other: DataFrame | Any) -> DataFrame: ...
    def exceptAll(self, other: DataFrame | Any) -> DataFrame: ...
    def join(
        self,
        other: DataFrame,
    ...
    def sampleBy(
        self,
        col: str,
        fractions: dict[str | int | float | bool, float],
        seed: int | None = None,
    ) -> DataFrame: ...
    def crosstab(self, col1: str, col2: str) -> DataFrame: ...
    def freqItems(self, columns: list[str], support: float = 0.01) -> DataFrame: ...
    def melt(self, id_vars: list[str], value_vars: list[str]) -> DataFrame: ...
    def unpivot(self, ids: list[str], values: list[str]) -> DataFrame: ...
...
class Column:
    ...
    def isNull(self) -> Column: ...  # PySpark alias for is_null
    def is_not_null(self) -> Column: ...
    def isNotNull(self) -> Column: ...  # PySpark alias for is_not_null
    def isin(
        self, *values: int | str | list[int] | list[str]
    ) -> Column: ...  # col.isin(1, 2, 3) or col.isin([1, 2, 3])
    ...
    def eqNullSafe(self, other: _ColumnOperand) -> Column: ...
    def between(self, low: _ColumnOperand, high: _ColumnOperand) -> Column: ...
    def getItem(self, index: int) -> Column: ...
    def getField(self, name: str) -> Column: ...
    def withField(self, name: str, value: Column) -> Column: ...
    ...
    def __pow__(self, other: _ColumnOperand, modulo: Any = ...) -> Column: ...
    def __rpow__(self, other: _ColumnOperand, modulo: Any = ...) -> Column: ...
    ...
    def cast(
        self, type_name: str | Any
    ) -> Column: ...  # DataType (e.g. IntegerType()) accepted
    def try_cast(self, type_name: str | Any) -> Column: ...
    def astype(self, type_name: str | Any) -> Column: ...
    ...
    def replace(
        self,
        to_replace: str | dict[str, str] | list[tuple[str, str]],
        replacement: str | None = None,
    ) -> Column: ...  # (search, replacement) or dict/list of (old, new)
    ...
    def posexplode(self) -> PosexplodeResult: ...
...
class GroupedData:
    ...
    def sum(self, column: str | Column) -> DataFrame: ...
    def avg(self, *columns: str | Column) -> DataFrame: ...
    def min(self, column: str | Column) -> DataFrame: ...
    def max(self, column: str | Column) -> DataFrame: ...
    ...
    def pivot(
        self, pivot_col: str, values: list[str] | None = None
    ) -> PivotedGroupedData: ...

class PivotedGroupedData:
    """Result of group_by(...).pivot(pivot_col). Call .sum(column), .avg(column), .count(), etc."""

    def sum(self, value_col: str) -> DataFrame: ...
    def avg(self, value_col: str) -> DataFrame: ...
    def min(self, value_col: str) -> DataFrame: ...
    def max(self, value_col: str) -> DataFrame: ...
    def count(self) -> DataFrame: ...
...
class Window:
    unboundedPreceding: int  # class constant for rowsBetween/rangeBetween
    currentRow: int
    ...
    def orderBy(self, *cols: Union[str, Column, SortOrder]) -> Window: ...
...
def dense_rank(descending: bool = False) -> DenseRank: ...
def lag(column: Column, offset: int = 1) -> Column: ...
def lead(column: Column, offset: int = 1) -> Column: ...
@overload
...
def min_by(value_column: Column, ord_column: Column) -> Column: ...
def max(column: Column) -> Column: ...
def max_by(value_column: Column, ord_column: Column) -> Column: ...
def try_sum(column: Column) -> Column: ...
def try_avg(column: Column) -> Column: ...
def count(column: Column) -> Column: ...
def first(column: Column, ignorenulls: bool = True) -> Column: ...
def any_value(column: Column, ignorenulls: bool = True) -> Column: ...
def count_if(column: Column) -> Column: ...
def corr(column1: Column, column2: Column) -> Column: ...
def covar_pop(column1: Column, column2: Column) -> Column: ...
def kurtosis(column: Column) -> Column: ...
def skewness(column: Column) -> Column: ...
def _execute_plan(
    data: Any,
    schema: list[tuple[str, str]],
    plan_json: str,
...
def decode(column: Column, charset: str) -> Column: ...
def encode(column: Column, charset: str) -> Column: ...
def unbase64(column: Column) -> Column: ...
def cast(column: Column, dtype: str | Any) -> Column: ...  # DataType accepted
def try_cast(column: Column, dtype: str | Any) -> Column: ...
def isnull(column: Column) -> Column: ...
def isnotnull(column: Column) -> Column: ...
def isnan(column: Column) -> Column: ...
def asc(column: Union[str, Column]) -> SortOrder: ...
def asc_nulls_first(column: Column) -> SortOrder: ...
def asc_nulls_last(column: Column) -> SortOrder: ...
def desc(column: Union[str, Column]) -> SortOrder: ...
...
def printf(fmt: str, *columns: Column) -> Column: ...
...
def power(base: Column, exp: int) -> Column: ...
...
def last_day(column: Column) -> Column: ...
...
def to_date(column: Column, format: str | None = None) -> Column: ...
...
def flatten(column: Column) -> Column: ...
def inline(column: Column) -> Column: ...
def inline_outer(column: Column) -> Column: ...

class PosexplodeResult(Iterable[Column]):
    """Result of posexplode(col); use .alias(\"pos\", \"val\") for select; unpack as pos, val = posexplode(...)."""

    def __iter__(self) -> Iterator[Column]: ...
    def alias(self, pos_name: str, val_name: str) -> tuple[Column, Column]: ...

def posexplode(column: Column | str) -> PosexplodeResult: ...
...
def approx_percentile(
    column: Column, percentage: float, accuracy: int | None = None
) -> Column: ...
def last(column: Column) -> Column: ...
def bool_and(column: Column) -> Column: ...
def collect_list(column: Column) -> Column: ...
def collect_set(column: Column) -> Column: ...
def every(column: Column) -> Column: ...
