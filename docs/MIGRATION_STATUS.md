...
- **Path to 100%** (ROADMAP Phases 12–17): DataFrame methods → 85, functions → 403 (three batches), parity fixtures → 150+, Phase 16 (publish Rust crate on crates.io), then Sparkless integration (Phase 17, 200+ tests). See [ROADMAP.md](ROADMAP.md) and [FULL_BACKEND_ROADMAP.md](FULL_BACKEND_ROADMAP.md).
