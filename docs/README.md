...
| [PARITY_STATUS](PARITY_STATUS.md) | PySpark parity coverage matrix (88 fixtures; Phases 12–15 covered) |
...
| [FULL_BACKEND_ROADMAP](FULL_BACKEND_ROADMAP.md) | Phased plan to full Sparkless backend replacement (Phases 12–15 done; ~55+ DataFrame methods, ~175+ functions, 88 fixtures; Phases 16–19: remaining gaps, Phase 20 crate publish, Phase 21 Sparkless integration) |
