...
| [PARITY_STATUS](PARITY_STATUS.md) | PySpark parity coverage matrix (54 fixtures) |
...
| [FULL_BACKEND_ROADMAP](FULL_BACKEND_ROADMAP.md) | Phased plan to full Sparkless backend replacement (Phase 7 SQL/Delta/performance done) |
