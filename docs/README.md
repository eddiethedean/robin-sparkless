...
| [PARITY_STATUS](PARITY_STATUS.md) | PySpark parity coverage matrix (73 fixtures) |
...
| [FULL_BACKEND_ROADMAP](FULL_BACKEND_ROADMAP.md) | Phased plan to full Sparkless backend replacement (Phase 8 & 10 done; ~120+ functions, 73 fixtures) |
