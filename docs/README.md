...
| [PARITY_STATUS](PARITY_STATUS.md) | PySpark parity coverage matrix (136 fixtures; Phases 12–21 covered) |
...
| [FULL_BACKEND_ROADMAP](FULL_BACKEND_ROADMAP.md) | Phased plan to full Sparkless backend replacement (Phases 12–21 done; ~240 functions, 136 fixtures; Phases 22–24 full parity, Phase 25 crate publish, Phase 26 Sparkless integration) |
