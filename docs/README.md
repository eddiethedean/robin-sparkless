...
| [PARITY_STATUS](PARITY_STATUS.md) | PySpark parity coverage matrix (103 fixtures; Phases 12–17 covered) |
...
| [FULL_BACKEND_ROADMAP](FULL_BACKEND_ROADMAP.md) | Phased plan to full Sparkless backend replacement (Phases 12–17 done; ~55+ DataFrame methods, ~192+ functions, 103 fixtures; Phases 18–19: remaining gaps, Phase 20 crate publish, Phase 21 Sparkless integration) |
