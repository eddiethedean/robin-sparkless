...
| [PARITY_STATUS](PARITY_STATUS.md) | PySpark parity coverage matrix (93 fixtures; Phases 12–16 covered) |
...
| [FULL_BACKEND_ROADMAP](FULL_BACKEND_ROADMAP.md) | Phased plan to full Sparkless backend replacement (Phases 12–16 done; ~55+ DataFrame methods, ~182+ functions, 93 fixtures; Phases 17–19: remaining gaps, Phase 20 crate publish, Phase 21 Sparkless integration) |
