...
- **Fixtures**: `tests/fixtures/*.json` (operations format); `tests/fixtures/plans/*.json` (plan format, see [LOGICAL_PLAN_FORMAT.md](LOGICAL_PLAN_FORMAT.md))
