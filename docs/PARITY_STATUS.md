...
| Plan execution | `execute_plan` (serialized logical plan) | ✅ Covered | `tests/fixtures/plans/filter_select_limit`, `join_simple` (plan_parity_fixtures) |
