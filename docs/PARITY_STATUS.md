...
Python phase smoke tests: `test_phase_a_signature_alignment`, `test_phase_b_functions`, `test_phase_c_reader_writer`, `test_phase_d_dataframe_methods`, `test_phase_e_spark_session_catalog`, `test_phase_f_behavioral`. See [TEST_CREATION_GUIDE.md](TEST_CREATION_GUIDE.md) for phase testing details.
