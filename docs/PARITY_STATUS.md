...
- **ROADMAP Phases 16–21**: Phase 16 completed. Phases 17–19 (remaining gaps: datetime/unix, array/map/struct, aggregates/try_*), Phase 20 (publish crate on crates.io), Phase 21 (Sparkless integration, 200+ tests). Optional: add parity fixtures for new Phase 17–19 functions. See [ROADMAP.md](ROADMAP.md), [GAP_ANALYSIS_SPARKLESS_3.28.md](GAP_ANALYSIS_SPARKLESS_3.28.md).
