...
| `array_distinct` | array_distinct(col) |
...
- **ROADMAP Phases 16–21**: Phase 15 completed. Phases 16–19 (remaining gaps: string/regex, datetime/unix, array/map/struct, aggregates/try_*), Phase 20 (publish crate on crates.io), Phase 21 (Sparkless integration, 200+ tests). Optional: add parity fixtures for new Phase 16–19 functions and for sample, random_split, summary, stat, to_json, to_df, select_expr, freq_items, crosstab, melt, except_all, intersect_all. See [ROADMAP.md](ROADMAP.md), [GAP_ANALYSIS_SPARKLESS_3.28.md](GAP_ANALYSIS_SPARKLESS_3.28.md).
