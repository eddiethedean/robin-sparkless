...
7. **Phase 5 Test Conversion** ✅ **COMPLETED**
  ...
  - `make sparkless-parity` (set `SPARKLESS_EXPECTED_OUTPUTS` to run converter first); 136 hand-written fixtures passing (array_distinct skipped).
...
10. **Path to 100% before Sparkless integration** ([ROADMAP.md](ROADMAP.md) Phases 12–21)
   ...
   - **Phases 22–24**: Full parity with Sparkless 3.28.0 (datetime extensions, JSON/CSV/URL, bit/control/JVM/random/crypto).
