...
- Remaining functional gaps (not compiler issues):
  ...
  - **Path to 100%**: ROADMAP Phases 16–21 — Phase 17 completed (~192+ functions, 103 fixtures). Phases 18–19 (remaining gaps: array/map/struct, aggregates/try_*), Phase 20 (publish Rust crate on crates.io), Phase 21 (Sparkless integration, 200+ tests). See [ROADMAP.md](ROADMAP.md) and [FULL_BACKEND_ROADMAP.md](FULL_BACKEND_ROADMAP.md).
